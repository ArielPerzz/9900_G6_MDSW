...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Christian Ortiz">
    <meta name="theme-color" content="#FF7bff;">
  ...
  <body>
    ...
    <section class="login-content">
      <div class="logo">
      <video  width="600px" height="180px" autoplay muted >  
        <source src="<?= media(); ?>/images/VideoProl.mp4" type="video/mp4"> 
      </video> 
      </div>
      <div class="login-box">
        <div id="divLoading" >
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          ...
          <div class="form-group mt-3">
            <p><a href="#" data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i> Iniciar sesión</a></p>
          </div>
        </form>
      </div>
    </section>
